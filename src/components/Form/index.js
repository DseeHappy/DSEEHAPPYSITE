...
export default () => {
  return (
    <div id="Contact_Us" className="op__block" data-aos="fade-up" data-aos-delay="200">
      <div className="container-fluid">
        <div className={style.form}>
          ...
          <div className="pt-3 mb-4">
            <button className="op__btn op__btn--blue">Contact Us</button>
          </div>
          <p className={`${style.form__disclaimer} text-muted`}>
            ...
            writing to us at dseehappy@gmail.com. Read our Privacy Policy to
